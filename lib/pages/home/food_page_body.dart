...
import 'package:home_food_delivery/pages/chef/chef_category.dart';
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              BigText(text:"${translateDataBase("الشيفات", " Chefs ")}"),
              GestureDetector(
                onTap: () => Get.to(const ListChefsScreen()),
                child: SmallText(
                  text: "${translateDataBase("اظهار المزيد", " see all ")}",
                  color: AppColors.mainColor,
                ),
              ),
            ],
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              BigText(text:"${translateDataBase("موصى به", " Recommended ")}"),
              SizedBox(
              ...
              Container(
                ...
                child: SmallText(
                  text:"${translateDataBase("الاقتران الغذائي", " Food Pairing ")}",
                ),
              )
            ],
          ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            //Image Section
                            Container(
                              child: Banner(location: BannerLocation.topStart, message: "${translateDataBase("عرض اليوم", "Daily offers")}",color: AppColors.mainColor,),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: index.isEven ? Color(0xFFFF0000) : Color(0xFFfcab88),
                    image: DecorationImage(
                        fit: BoxFit.cover,
